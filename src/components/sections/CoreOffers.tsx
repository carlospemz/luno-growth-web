...
const OFFERS: Offer[] = [
  {
    ...
    accent: "#4B8BF5",
    accentGlow: "rgba(75, 139, 245, 0.25)",
    accentSoft: "rgba(75, 139, 245, 0.08)",
    accentBorder: "rgba(75, 139, 245, 0.35)",
...
function OfferCard({ offer, index }: { offer: Offer; index: number }) {
  ...
  const ribbonColors = {
    cobalt: {
      bg: "rgba(75, 139, 245, 0.12)",
      border: "rgba(75, 139, 245, 0.35)",
      text: "#4B8BF5",
    },
    gold: {
      bg: "rgba(232, 185, 49, 0.12)",
      border: "rgba(232, 185, 49, 0.4)",
      text: "#E8B931",
    },
    ember: {
