...
const ADDONS: Addon[] = [
  {
    ...
    offerKey: "website",
    accent: "#8BADC4",
    accentGlow: "rgba(139, 173, 196, 0.18)",
    accentSoft: "rgba(139, 173, 196, 0.06)",
    accentBorder: "rgba(139, 173, 196, 0.22)",
  },
  {
    badge: "Retención",
    icon: MapPin,
    ...
    accent: "#A0B5A3",
    accentGlow: "rgba(160, 181, 163, 0.18)",
    accentSoft: "rgba(160, 181, 163, 0.06)",
    accentBorder: "rgba(160, 181, 163, 0.22)",
  },
  {
    badge: "Bundle",
    icon: GitMerge,
