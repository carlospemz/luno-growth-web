...
const ADDONS: Addon[] = [
  {
    ...
    offerKey: "website",
    accent: "#9B8EC4",
    accentGlow: "rgba(155, 142, 196, 0.18)",
    accentSoft: "rgba(155, 142, 196, 0.06)",
    accentBorder: "rgba(155, 142, 196, 0.22)",
  },
  {
    badge: "Retención",
    icon: MapPin,
    ...
    accent: "#7BAA8E",
    accentGlow: "rgba(123, 170, 142, 0.18)",
    accentSoft: "rgba(123, 170, 142, 0.06)",
    accentBorder: "rgba(123, 170, 142, 0.22)",
  },
  {
    badge: "Bundle",
    icon: GitMerge,
